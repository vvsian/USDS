...
let subordonataData = [
  // --- Subiectiva ---
  {
    question: "Ce este propozitia subordonata subiectiva?",
    options: ["Arata locul actiunii", "Indeplineste functia de subiect", "Arata cauza actiunii", "Explica un substantiv"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 1): Subordonata subiectiva e o propozitie care raspunde la 'cine?' sau 'ce?' si joaca rolul subiectului pentru regenta. Exemplu: E bine ca a venit la timp."
  },
  {
    question: "Care e o intrebare pentru subordonata subiectiva?",
    options: ["Cum?", "Unde?", "Cine?", "De ce?"],
    correctIndex: 2,
    explanation: "Explicatie (pagina 1): Subordonata subiectiva raspunde la intrebarile 'cine?' sau 'ce?'. Exemplu: Cine munceste are de toate."
  },
  {
    question: "Ce fel de termen regent are subordonata subiectiva?",
    options: ["Substantiv", "Verb impersonal", "Adjectiv", "Prepozitie"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 1): Subordonata subiectiva e legata de verbe impersonale ca 'este' sau 'trebuie' ori expresii ca 'e bine'. Exemplu: Se zice ca ploua."
  },
  {
    question: "Ce element de relatie foloseste subordonata subiectiva?",
    options: ["Numai adverbe", "Conjunctia 'ca'", "Numai prepozitii", "Numai verbe"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 1): Subordonata subiectiva foloseste conjunctii ca 'ca', 'sa', 'daca' sau pronume ca 'cine'. Exemplu: Nu se stie daca vine."
  },
  // --- Predicativa ---
  {
    question: "Ce este propozitia subordonata predicativa?",
    options: ["Arata scopul actiunii", "Indeplineste functia de nume predicativ", "Explica un substantiv", "Arata timpul actiunii"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 2): Subordonata predicativa completeaza un verb copulativ ca 'a fi' sau 'a deveni' ca nume predicativ. Exemplu: Hotararea lor este ca vor veni."
  },
  {
    question: "Care e o intrebare pentru subordonata predicativa?",
    options: ["Unde?", "Ce?", "De ce?", "Cand?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 2): Subordonata predicativa raspunde la intrebarile 'ce?', 'cine?' sau 'cum?'. Exemplu: Intrebarea este ce vor face."
  },
  {
    question: "Ce termen regent are subordonata predicativa?",
    options: ["Verb copulativ", "Substantiv", "Adverb", "Interjectie"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 2): Subordonata predicativa e legata de verbe copulative ca 'a fi', 'a deveni' sau 'a parea'. Exemplu: El a devenit ce si-a dorit."
  },
  {
    question: "Ce element de relatie foloseste subordonata predicativa?",
    options: ["Numai prepozitii", "Conjunctia 'daca'", "Numai verbe", "Numai substantive"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 2): Subordonata predicativa foloseste conjunctii ca 'ca', 'sa', 'daca' sau locutiuni ca 'de parca'. Exemplu: Propunerea mea este sa plecam."
  },
  // --- Atributiva ---
  {
    question: "Ce este propozitia subordonata atributiva?",
    options: ["Arata locul actiunii", "Indeplineste functia de atribut", "Arata cauza actiunii", "Completeaza un verb"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 3): Subordonata atributiva descrie un substantiv sau pronume din regenta, fiind atribut. Exemplu: El este baiatul pe care l-am cautat."
  },
  {
    question: "Care e o intrebare pentru subordonata atributiva?",
    options: ["Cui?", "Care?", "Cand?", "De ce?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 3): Subordonata atributiva raspunde la intrebarile 'care?', 'cat?', 'ce fel de?'. Exemplu: Am urmat sfatul ce mi l-ai dat."
  },
  {
    question: "Ce termen regent are subordonata atributiva?",
    options: ["Verb", "Substantiv", "Adverb", "Conjunctie"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 3): Subordonata atributiva e legata de un substantiv, pronume sau numeral din regenta. Exemplu: Nu cunosc locul unde merge."
  },
  {
    question: "Ce element de relatie foloseste subordonata atributiva?",
    options: ["Pronumele 'care'", "Numai verbe", "Numai adverbe", "Numai prepozitii"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 3): Subordonata atributiva foloseste pronume ca 'care', 'ce' sau conjunctii ca 'sa'. Exemplu: A luat hotararea sa vina."
  },
  // --- Completiva directa ---
  {
    question: "Ce este propozitia subordonata completiva directa?",
    options: ["Arata scopul actiunii", "Indeplineste functia de complement direct", "Explica un substantiv", "Arata timpul actiunii"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 4): Subordonata completiva directa completeaza un verb tranzitiv ca 'a sti' sau 'a invata'. Exemplu: Nu stie cine vine."
  },
  {
    question: "Care e o intrebare pentru subordonata completiva directa?",
    options: ["Unde?", "Pe cine?", "De ce?", "Cand?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 4): Subordonata completiva directa raspunde la intrebarile 'pe cine?' sau 'ce?'. Exemplu: Am auzit ca a venit."
  },
  {
    question: "Ce termen regent are subordonata completiva directa?",
    options: ["Verb tranzitiv", "Substantiv", "Adjectiv", "Prepozitie"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 4): Subordonata completiva directa e legata de verbe tranzitive sau locutiuni verbale tranzitive. Exemplu: A invatat sa citeasca."
  },
  {
    question: "Ce element de relatie foloseste subordonata completiva directa?",
    options: ["Numai prepozitii", "Conjunctia 'ca'", "Numai verbe", "Numai substantive"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 4): Subordonata completiva directa foloseste conjunctii ca 'ca', 'sa' sau pronume ca 'cine'. Exemplu: Nu stie daca vine."
  },
  // --- Completiva indirecta ---
  {
    question: "Ce este propozitia subordonata completiva indirecta?",
    options: ["Arata locul actiunii", "Indeplineste functia de complement indirect", "Arata cauza actiunii", "Explica un substantiv"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 5): Subordonata completiva indirecta completeaza un verb sau adjectiv, raspunzand la 'cui?' sau 'despre ce?'. Exemplu: Se gandea la cine va veni."
  },
  {
    question: "Care e o intrebare pentru subordonata completiva indirecta?",
    options: ["Cand?", "Cui?", "Care?", "De ce?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 5): Subordonata completiva indirecta raspunde la intrebarile 'cui?', 'despre cine?', 'de cine?'. Exemplu: Povesteste cui il asculta."
  },
  {
    question: "Ce termen regent are subordonata completiva indirecta?",
    options: ["Substantiv", "Verb personal", "Conjunctie", "Adverb"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 5): Subordonata completiva indirecta e legata de verbe personale, adjective sau locutiuni. Exemplu: Nu si-a dat seama ce s-a intamplat."
  },
  {
    question: "Ce element de relatie foloseste subordonata completiva indirecta?",
    options: ["Pronumele 'cui'", "Numai verbe", "Numai adverbe", "Numai prepozitii"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 5): Subordonata completiva indirecta foloseste pronume ca 'cui', 'care' sau conjunctii ca 'ca'. Exemplu: S-a mirat cum de a rezistat."
  },
  // --- Circumstantiala de loc ---
  {
    question: "Ce este propozitia subordonata circumstantiala de loc?",
    options: ["Arata locul actiunii", "Arata scopul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 6): Subordonata circumstantiala de loc arata unde se intampla actiunea din regenta. Exemplu: Vine de unde a fost trimis."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala de loc?",
    options: ["Cand?", "Unde?", "De ce?", "Cui?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 6): Subordonata circumstantiala de loc raspunde la intrebarile 'unde?', 'de unde?', 'pana unde?'. Exemplu: Nu merge unde au stabilit."
  },
  {
    question: "Ce termen regent are subordonata circumstantiala de loc?",
    options: ["Verb", "Substantiv", "Prepozitie", "Conjunctie"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 6): Subordonata circumstantiala de loc e legata de verbe, adjective sau adverbe. Exemplu: Acolo unde ai fost tu n-a ajuns nimeni."
  },
  {
    question: "Ce element de relatie foloseste subordonata circumstantiala de loc?",
    options: ["Adverbul 'unde'", "Numai verbe", "Numai prepozitii", "Numai substantive"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 6): Subordonata circumstantiala de loc foloseste adverbe ca 'unde', 'oriunde' sau pronume cu prepozitii. Exemplu: Oriunde privesti vezi locuri minunate."
  },
  // --- Circumstantiala de timp ---
  {
    question: "Ce este propozitia subordonata circumstantiala de timp?",
    options: ["Arata timpul actiunii", "Arata scopul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 7): Subordonata circumstantiala de timp arata cand se petrece actiunea din regenta. Exemplu: Vine cand poate."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala de timp?",
    options: ["Unde?", "Cand?", "De ce?", "Cui?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 7): Subordonata circumstantiala de timp raspunde la intrebarile 'cand?', 'de cand?', 'pana cand?'. Exemplu: Dupa ce i-a intalnit s-a intors."
  },
  {
    question: "Ce termen regent are subordonata circumstantiala de timp?",
    options: ["Substantiv", "Verb", "Prepozitie", "Conjunctie"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 7): Subordonata circumstantiala de timp e legata de verbe, adjective sau locutiuni adverbiale. Exemplu: Azi cand te-am cautat nu erai acasa."
  },
  {
    question: "Ce element de relatie foloseste subordonata circumstantiala de timp?",
    options: ["Adverbul 'cand'", "Numai verbe", "Numai prepozitii", "Numai substantive"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 7): Subordonata circumstantiala de timp foloseste adverbe ca 'cand', 'oricand' sau locutiuni ca 'dupa ce'. Exemplu: Ori de cate ori ploua isi ia umbrela."
  },
  // --- Circumstantiala de mod ---
  {
    question: "Ce este propozitia subordonata circumstantiala de mod?",
    options: ["Arata modul actiunii", "Arata locul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 8): Subordonata circumstantiala de mod arata cum se desfasoara actiunea din regenta. Exemplu: A procedat cum l-ai sfatuit."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala de mod?",
    options: ["Unde?", "Cum?", "Cand?", "De ce?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 8): Subordonata circumstantiala de mod raspunde la intrebarile 'cum?', 'in ce fel?', 'cat de?'. Exemplu: Munceste cum muncesc toti."
  },
  // --- Circumstantiala de cauza ---
  {
    question: "Ce este propozitia subordonata circumstantiala de cauza?",
    options: ["Arata locul actiunii", "Arata cauza actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 9): Subordonata circumstantiala de cauza arata de ce se intampla actiunea din regenta. Exemplu: N-a venit pentru ca a fost retinut."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala de cauza?",
    options: ["Din ce cauza?", "Unde?", "Cand?", "Cui?"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 9): Subordonata circumstantiala de cauza raspunde la intrebarile 'din ce cauza?', 'din ce pricina?'. Exemplu: Lipeste ca e bolnav."
  },
  // --- Circumstantiala de scop ---
  {
    question: "Ce este propozitia subordonata circumstantiala de scop?",
    options: ["Arata scopul actiunii", "Arata timpul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 10): Subordonata circumstantiala de scop arata in ce scop se face actiunea din regenta. Exemplu: Vine la biblioteca sa imprumute carti."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala de scop?",
    options: ["Unde?", "In ce scop?", "Cand?", "De ce?"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 10): Subordonata circumstantiala de scop raspunde la intrebarile 'in ce scop?', 'cu ce scop?'. Exemplu: Invata pentru ca sa reuseasca."
  },
  // --- Circumstantiala conditionala ---
  {
    question: "Ce este propozitia subordonata circumstantiala conditionala?",
    options: ["Arata locul actiunii", "Arata conditia actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 1,
    explanation: "Explicatie (pagina 11): Subordonata circumstantiala conditionala arata conditia necesara pentru actiunea din regenta. Exemplu: Daca doresti vino la mine."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala conditionala?",
    options: ["Cu ce conditie?", "Unde?", "Cand?", "De ce?"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 11): Subordonata circumstantiala conditionala raspunde la intrebarea 'cu ce conditie?'. Exemplu: In caz ca ploua imi voi lua umbrela."
  },
  // --- Circumstantiala concesiva ---
  {
    question: "Ce este propozitia subordonata circumstantiala concesiva?",
    options: ["Arata o imprejurare care nu impiedica actiunea", "Arata locul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 12): Subordonata circumstantiala concesiva arata un obstacol care nu opreste actiunea din regenta. Exemplu: Desi este bolnav a venit la scoala."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala concesiva?",
    options: ["In ciuda carui fapt?", "Unde?", "Cand?", "De ce?"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 12): Subordonata circumstantiala concesiva raspunde la intrebarea 'in ciuda carui fapt?'. Exemplu: Orice s-ar intampla nu plec acolo."
  },
  // --- Circumstantiala consecutiva ---
  {
    question: "Ce este propozitia subordonata circumstantiala consecutiva?",
    options: ["Arata urmarea unei actiuni", "Arata timpul actiunii", "Explica un substantiv", "Completeaza un verb"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 13): Subordonata circumstantiala consecutiva arata ce rezulta din actiunea sau insusirea din regenta. Exemplu: Vorbeste atat de tare incat il aud toti."
  },
  {
    question: "Care e o intrebare pentru subordonata circumstantiala consecutiva?",
    options: ["Care este urmarea faptului ca?", "Unde?", "Cand?", "De ce?"],
    correctIndex: 0,
    explanation: "Explicatie (pagina 13): Subordonata circumstantiala consecutiva raspunde la intrebarea 'care este urmarea faptului ca?'. Exemplu: Era frumoasa incat nu te puteai uita la ea."
  }
];
...
const tests = [
     ...
     {
        title: "Test de Practică: Propoziții Subordonate",
        subject: "Litteratura",
        source: "subordonata.pdf",
        data: subordonataData,
        context: `Ce este propozitia subordonata subiectiva?
a) Arata locul actiunii
b) Indeplineste functia de subiect
c) Arata cauza actiunii
d) Explica un substantiv

Raspuns corect: b) Indeplineste functia de subiect
Explicatie (pagina 1): Subordonata subiectiva e o propozitie care raspunde la "cine?" sau "ce?" si joaca rolul subiectului pentru regenta.
Exemplu de propozitie: E bine ca a venit la timp.


Care e o intrebare pentru subordonata subiectiva?
a) Cum?
b) Unde?
c) Cine?
d) De ce?

Raspuns corect: c) Cine?
Explicatie (pagina 1): Subordonata subiectiva raspunde la intrebarile "cine?" sau "ce?".
Exemplu de propozitie: Cine munceste are de toate.


Ce fel de termen regent are subordonata subiectiva?
a) Substantiv
b) Verb impersonal
c) Adjectiv
d) Prepozitie

Raspuns corect: b) Verb impersonal
Explicatie (pagina 1): Subordonata subiectiva e legata de verbe impersonale ca "este" sau "trebuie" ori expresii ca "e bine".
Exemplu de propozitie: Se zice ca ploua.


Ce element de relatie foloseste subordonata subiectiva?
a) Numai adverbe
b) Conjunctia "ca"
c) Numai prepozitii
d) Numai verbe

Raspuns corect: b) Conjunctia "ca"
Explicatie (pagina 1): Subordonata subiectiva foloseste conjunctii ca "ca", "sa", "daca" sau pronume ca "cine".
Exemplu de propozitie: Nu se stie daca vine.


Ce este propozitia subordonata predicativa?
a) Arata scopul actiunii
b) Indeplineste functia de nume predicativ
c) Explica un substantiv
d) Arata timpul actiunii

Raspuns corect: b) Indeplineste functia de nume predicativ
Explicatie (pagina 2): Subordonata predicativa completeaza un verb copulativ ca "a fi" sau "a deveni" ca nume predicativ.
Exemplu de propozitie: Hotararea lor este ca vor veni.


Care e o intrebare pentru subordonata predicativa?
a) Unde?
b) Ce?
c) De ce?
d) Cand?
...
Raspuns corect: b) Ce?
Explicatie (pagina 2): Subordonata predicativa raspunde la intrebarile "ce?", "cine?" sau "cum?".
Exemplu de propozitie: Intrebarea este ce vor face.


Ce termen regent are subordonata predicativa?
a) Verb copulativ
b) Substantiv
c) Adverb
d) Interjectie

Raspuns corect: a) Verb copulativ
Explicatie (pagina 2): Subordonata predicativa e legata de verbe copulative ca "a fi", "a deveni" sau "a parea".
Exemplu de propozitie: El a devenit ce si-a dorit.


Ce element de relatie foloseste subordonata predicativa?
a) Numai prepozitii
b) Conjunctia "daca"
c) Numai verbe
d) Numai substantive

Raspuns corect: b) Conjunctia "daca"
Explicatie (pagina 2): Subordonata predicativa foloseste conjunctii ca "ca", "sa", "daca" sau locutiuni ca "de parca".
Exemplu de propozitie: Propunerea mea este sa plecam.


Ce este propozitia subordonata atributiva?
a) Arata locul actiunii
b) Indeplineste functia de atribut
c) Arata cauza actiunii
d) Completeaza un verb

Raspuns corect: b) Indeplineste functia de atribut
Explicatie (pagina 3): Subordonata atributiva descrie un substantiv sau pronume din regenta, fiind atribut.
Exemplu de propozitie: El este baiatul pe care l-am cautat.


Care e o intrebare pentru subordonata atributiva?
a) Cui?
b) Care?
c) Cand?
d) De ce?

Raspuns corect: b) Care?
Explicatie (pagina 3): Subordonata atributiva raspunde la intrebarile "care?", "cat?", "ce fel de?".
Exemplu de propozitie: Am urmat sfatul ce mi l-ai dat.


Ce termen regent are subordonata atributiva?
a) Verb
b) Substantiv
c) Adverb
d) Conjunctie

Raspuns corect: b) Substantiv
Explicatie (pagina 3): Subordonata atributiva e legata de un substantiv, pronume sau numeral din regenta.
Exemplu de propozitie: Nu cunosc locul unde merge.


Ce element de relatie foloseste subordonata atributiva?
a) Pronumele "care"
b) Numai verbe
c) Numai adverbe
d) Numai prepozitii

Raspuns corect: a) Pronumele "care"
Explicatie (pagina 3): Subordonata atributiva foloseste pronume ca "care", "ce" sau conjunctii ca "sa".
Exemplu de propozitie: A luat hotararea sa vina.


Ce este propozitia subordonata completiva directa?
a) Arata scopul actiunii
b) Indeplineste functia de complement direct
c) Explica un substantiv
d) Arata timpul actiunii

Raspuns corect: b) Indeplineste functia de complement direct
Explicatie (pagina 4): Subordonata completiva directa completeaza un verb tranzitiv ca "a sti" sau "a invata".
Exemplu de propozitie: Nu stie cine vine.


Care e o intrebare pentru subordonata completiva directa?
a) Unde?
b) Pe cine?
c) De ce?
d) Cand?

Raspuns corect: b) Pe cine?
Explicatie (pagina 4): Subordonata completiva directa raspunde la intrebarile "pe cine?" sau "ce?".
Exemplu de propozitie: Am auzit ca a venit.


Ce termen regent are subordonata completiva directa?
a) Verb tranzitiv
b) Substantiv
c) Adjectiv
d) Prepozitie

Raspuns corect: a) Verb tranzitiv
Explicatie (pagina 4): Subordonata completiva directa e legata de verbe tranzitive sau locutiuni verbale tranzitive.
Exemplu de propozitie: A invatat sa citeasca.


Ce element de relatie foloseste subordonata completiva directa?
a) Numai prepozitii
b) Conjunctia "ca"
c) Numai verbe
d) Numai substantive
...
Raspuns corect: b) Conjunctia "ca"
Explicatie (pagina 4): Subordonata completiva directa foloseste conjunctii ca "ca", "sa" sau pronume ca "cine".
Exemplu de propozitie: Nu stie daca vine.


Ce este propozitia subordonata completiva indirecta?
a) Arata locul actiunii
b) Indeplineste functia de complement indirect
c) Arata cauza actiunii
d) Explica un substantiv

Raspuns corect: b) Indeplineste functia de complement indirect
Explicatie (pagina 5): Subordonata completiva indirecta completeaza un verb sau adjectiv, raspunzand la "cui?" sau "despre ce?".
Exemplu de propozitie: Se gandea la cine va veni.`
        }
    ];
